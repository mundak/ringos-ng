...
function(
  ...
  elseif(RINGOS_TEST_APP_PROJECT_PATH)
    ...
    foreach(project_dependency_path IN LISTS RINGOS_TEST_APP_PROJECT_DEPENDENCY_PATHS)
      file(GLOB_RECURSE ARM64_TEST_APP_PROJECT_DEPENDENCY_INPUTS CONFIGURE_DEPENDS ${project_dependency_path}/*)
      list(APPEND ARM64_TEST_APP_PROJECT_INPUTS ${ARM64_TEST_APP_PROJECT_DEPENDENCY_INPUTS})
    endforeach()

    list(REMOVE_DUPLICATES ARM64_TEST_APP_PROJECT_INPUTS)
