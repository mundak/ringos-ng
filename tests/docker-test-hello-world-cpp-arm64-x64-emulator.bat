@echo off
REM Build and run the hello_world_cpp arm64 x64-emulator sample test inside a Docker container.
REM Usage: tests\docker-test-hello-world-cpp-arm64-x64-emulator.bat
