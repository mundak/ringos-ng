...
enum pe_image_load_status : uint32_t
{
  PE_IMAGE_LOAD_STATUS_OK = 0,
  PE_IMAGE_LOAD_STATUS_INVALID_ARGUMENT,
  PE_IMAGE_LOAD_STATUS_MISSING_DOS_HEADER,
  PE_IMAGE_LOAD_STATUS_INVALID_DOS_HEADER,
  PE_IMAGE_LOAD_STATUS_MISSING_NT_HEADERS,
  PE_IMAGE_LOAD_STATUS_INVALID_NT_SIGNATURE,
  PE_IMAGE_LOAD_STATUS_WRONG_MACHINE,
  PE_IMAGE_LOAD_STATUS_MISSING_SECTIONS,
  PE_IMAGE_LOAD_STATUS_UNSUPPORTED_OPTIONAL_HEADER,
  PE_IMAGE_LOAD_STATUS_UNSUPPORTED_MAGIC,
  PE_IMAGE_LOAD_STATUS_UNEXPECTED_IMAGE_BASE,
  PE_IMAGE_LOAD_STATUS_UNSUPPORTED_ALIGNMENT,
  PE_IMAGE_LOAD_STATUS_IMAGE_TOO_LARGE,
  PE_IMAGE_LOAD_STATUS_HEADERS_OUT_OF_RANGE,
  PE_IMAGE_LOAD_STATUS_ENTRY_POINT_OUT_OF_RANGE,
  PE_IMAGE_LOAD_STATUS_INVALID_IMPORT_DIRECTORY,
  PE_IMAGE_LOAD_STATUS_UNEXPECTED_IMPORTS,
  PE_IMAGE_LOAD_STATUS_UNEXPECTED_RELOCATIONS,
  PE_IMAGE_LOAD_STATUS_TRUNCATED_SECTION_TABLE,
  PE_IMAGE_LOAD_STATUS_SECTION_OUT_OF_RANGE,
  PE_IMAGE_LOAD_STATUS_SECTION_DATA_OUT_OF_RANGE,
};
