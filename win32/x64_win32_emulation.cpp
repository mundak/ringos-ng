...
namespace
{
  ...
  x64_pe64_import_resolution_status resolve_x64_win32_import(
    void* context,
    const char* dll_name,
    ...
    uint64_t* out_function_address)
  {
    ...
    {
      return X64_PE64_IMPORT_RESOLUTION_STATUS_INVALID_ARGUMENT;
    }
    ...
    {
      return X64_PE64_IMPORT_RESOLUTION_STATUS_UNSUPPORTED_IMPORT;
    }

    if (resolved_export->syscall_number > 0xFFFFFFFFULL)
    {
      return X64_PE64_IMPORT_RESOLUTION_STATUS_IMPORT_STUB_OUT_OF_RANGE;
    }
    ...
    *inout_next_stub_offset = stub_offset + X64_WIN32_IMPORT_STUB_SIZE;
    return X64_PE64_IMPORT_RESOLUTION_STATUS_OK;
  }

  constexpr x64_pe64_import_resolver X64_WIN32_IMPORT_RESOLVER {
    nullptr,
    &resolve_x64_win32_import,
  };
}

const x64_pe64_import_resolver* get_x64_win32_import_resolver()
{
  return &X64_WIN32_IMPORT_RESOLVER;
}
