...
docker run --rm %IMAGE_NAME% bash -lc "cmake --preset x64-ci && cmake --build --preset build-x64-ci && ctest --preset x64_emulator_unit && ctest --preset x64_win32_loader_unit && ctest --preset smoke_x64_native"
if %errorlevel% neq 0 (
