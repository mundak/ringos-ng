...
docker run --rm -it %IMAGE_NAME% bash -lc "cmake --preset arm64-debug && cmake --build --preset build-arm64-debug && scripts/run-arm64.sh build/arm64-debug/arch/arm64/ringos_arm64"
if %errorlevel% neq 0 (
