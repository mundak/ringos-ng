...
set(RINGOS_X64_EMULATOR_UNIT_TEST_BINARY ${CMAKE_BINARY_DIR}/x64_emulator_unit_tests)

set(RINGOS_X64_EMULATOR_UNIT_TEST_SOURCES
...
add_custom_command(
  OUTPUT ${RINGOS_X64_EMULATOR_UNIT_TEST_BINARY}
...
add_custom_target(ringos_x64_emulator_unit_tests ALL DEPENDS ${RINGOS_X64_EMULATOR_UNIT_TEST_BINARY})

add_test(
  NAME x64_emulator_unit
  COMMAND ${RINGOS_X64_EMULATOR_UNIT_TEST_BINARY}
)
