function(
  ...
  set(RINGOS_SDK_SYSCALL_OBJECT ${CMAKE_CURRENT_BINARY_DIR}/ringos_arm64_syscall.obj)
  set(RINGOS_SDK_DEBUG_OBJECT ${CMAKE_CURRENT_BINARY_DIR}/ringos_arm64_debug.obj)
  set(RINGOS_SDK_PROCESS_OBJECT ${CMAKE_CURRENT_BINARY_DIR}/ringos_arm64_process.obj)
  set(RINGOS_SDK_LIBRARY ${CMAKE_CURRENT_BINARY_DIR}/ringos_arm64_sdk.lib)
  ...
  add_custom_command(
    ...
    COMMENT "Building embedded arm64 PE64 test app with the ringos C SDK"
    VERBATIM
  )
