function(
  ...
  set(RINGOS_SDK_SYSCALL_SOURCE ${CMAKE_SOURCE_DIR}/sdk/x64/ringos_syscall.S)
  ...
  set(RINGOS_SDK_SYSCALL_OBJECT ${CMAKE_CURRENT_BINARY_DIR}/${RINGOS_TEST_APP_BINARY_STEM}_ringos_syscall.obj)
  set(RINGOS_SDK_DEBUG_OBJECT ${CMAKE_CURRENT_BINARY_DIR}/${RINGOS_TEST_APP_BINARY_STEM}_ringos_debug.obj)
  set(RINGOS_SDK_PROCESS_OBJECT ${CMAKE_CURRENT_BINARY_DIR}/${RINGOS_TEST_APP_BINARY_STEM}_ringos_process.obj)
  ...
  set(RINGOS_SDK_LIBRARY ${CMAKE_CURRENT_BINARY_DIR}/${RINGOS_TEST_APP_BINARY_STEM}_ringos_sdk.lib)
  ...
  set(RINGOS_SDK_COPY_COMMANDS)
  set(RINGOS_SDK_SYSROOT_BYPRODUCTS)

  if(RINGOS_TEST_APP_BINARY_STEM STREQUAL "ringos_test_app_x64_pe64_image")
    ...
    set(RINGOS_SDK_COPY_COMMANDS
      ...
      COMMAND ${CMAKE_COMMAND} -E copy_directory ${RINGOS_USER_INCLUDE_DIR} ${RINGOS_SDK_SYSROOT_INCLUDE_DIR}
      COMMAND ${CMAKE_COMMAND} -E copy_if_different ${RINGOS_SDK_LIBRARY} ${RINGOS_SDK_SYSROOT_LIBRARY})
    set(RINGOS_SDK_SYSROOT_BYPRODUCTS ${RINGOS_SDK_SYSROOT_LIBRARY})
  endif()
  ...
  if(RINGOS_TEST_APP_SOURCE_EXTENSION STREQUAL ".c")
    add_custom_command(
      ...
      BYPRODUCTS
        ...
        ${RINGOS_USER_STDIO_OBJECT}
        ${RINGOS_SDK_LIBRARY}
        ${RINGOS_SDK_SYSROOT_BYPRODUCTS}
        ${X64_TEST_APP_OBJECT}
        ${X64_TEST_APP_IMAGE}
        ${X64_TEST_APP_WINDOWS_EXE}
      COMMENT "Building embedded x64 PE64 test app with the ringos C SDK and user runtime"
      VERBATIM
    )
  else()
    add_custom_command(
